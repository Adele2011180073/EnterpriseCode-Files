//
//  HZBanShiContenWebViewViewController.m
//  HZGHJ
//
...
@interface HZBanShiContenWebViewViewController ()<WKNavigationDelegate,UIGestureRecognizerDelegate,UINavigationControllerDelegate>{
    WKWebView *webview;
}
...
@implementation HZBanShiContenWebViewViewController
...
- (void)viewDidLoad {
    ...
    NSString *serviceURL=[NSString stringWithFormat:@"%@",[self.sourceData objectForKey:@"url"]];
