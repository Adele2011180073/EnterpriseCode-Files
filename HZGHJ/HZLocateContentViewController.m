...
//     _mainBgView.contentSize=CGSizeMake(520-6, 1350);
    ...
    if (self.uuid==NULL||self.uuid==nil) {
        ...
        self.qlsxcode=[self.commitData objectForKey:@"qlsxcode"];
        ...
        [self getImageNameArray];
        self.orgId=[[self.commitData objectForKey:@"orgId"]intValue];
    ...
    for (int i=0; i<statusLabelArray.count; i++) {
        ...
        if (i==5||i==6) {
            ...
            if (i==6) {
                ...
                if (![[self.commitData objectForKey:@"sxslh"]isEqual:[NSNull null]]) {
                    _textfield.text=[self.commitData objectForKey:@"sxslh"];
                }
