//
//  HZBanShiContenViewController.m
//  HZGHJ
//
...
#import "HZBanShiContenViewController.h"
#import "MBProgressHUD.h"
#import "HZBanShiService.h"
#import "HZBanShiContenWebViewViewController.h"

@interface HZBanShiContenViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation HZBanShiContenViewController
@synthesize dataList;
...
-(void)getReturnData{
    ...
    [HZBanShiService BanShiWithId:Pid GetBlock:^(NSDictionary *returnDic, NSError *error) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([[dic objectForKey:@"isparent"]isEqualToString:@"yes"]) {
        HZBanShiContenViewController *details=[[HZBanShiContenViewController alloc]init];
        details.sourceData=dic;
        [self.navigationController pushViewController:details animated:YES];
    }else{
        HZBanShiContenWebViewViewController *details=[[HZBanShiContenWebViewViewController alloc]init];
        details.sourceData=dic;
        [self.navigationController pushViewController:details animated:YES];
    }
