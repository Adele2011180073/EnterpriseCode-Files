...
#import "HZBiaoGeViewController.h"
...
@interface HZBiaoGeViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
@implementation HZBiaoGeViewController
@synthesize dataList;
...
-(void)getReturnData{
    [HZBanShiService BiaoGeWithId:@"0" GetBlock:^(NSDictionary *returnDic, NSError *error) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    NSDictionary *dic=[dataList objectAtIndex:indexPath.row];
    if ([[dic objectForKey:@"isparent"]isEqualToString:@"no"]) {
