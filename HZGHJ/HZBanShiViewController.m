...
@interface HZBanShiViewController ()<UITableViewDataSource,UITableViewDelegate>{
...
-(void)getReturnData{
    [HZBanShiService BanShiWithId:@"0" GetBlock:^(NSDictionary *returnDic, NSError *error) {
